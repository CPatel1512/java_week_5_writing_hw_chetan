...
public class Programme_10_TubeLine_Advanced {
    ...
    public static void main(String[] args) {
        String station[] = ("Aldgate,Angle,Baker Street,Bank,Babican,bayswater,blackfriars,bond street," +
                "borough,cannon street,Chancery lane,Charing cros,covent garden,earl's court," +
                "Edgware road,elephant & castel,embankment,euston square, +" +
